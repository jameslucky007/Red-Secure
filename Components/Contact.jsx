              ...
              <div className="right-container">
                ...
                <div className="list-icon">
                  ...
                  <h3 className="right-text">
                    Address: RedSecure Middle East HQ, Al Fajer complex, 1st
                    Floor Office - 105, Oud Metha Dubai, UAE
                  </h3>
                </div>
                ...
                <div className="list-icon">
                  ...
                  ></iconify-icon>
                  <h3 className="right-text">
                    Phone No: +971 50 948 3857, +971 43 426 284
                  </h3>
                </div>
