...
import { FaGripLinesVertical, FaBraille } from "react-icons/fa";
    ...
    <link rel="icon" href="/tabicon.png" />
      ...
      <div className="container">
        <div className="row">
          <div className="col-lg-12">
            {/* Blog Section 1 */}
            <div className="blog-content" id="red-secure-vapt-services">
              <img src="/vapt.jpg" alt="Image" id="VAPT" />
              <h2>Red Secure VAPT Services</h2>
              <p>
            ...
            {/* Blog Section 2 */}
            <div className="blog-content" id="cyber-security-vapt-infra">
              <img src="/firewall.jpg" alt="Image" id="VAPT-infra" />
              <h2>Cyber Security, VAPT & Infra Solutions</h2>
              <p>     Greetings to you…. <br /><br />
...
<br /><br />
We have a complete In-House expertise and certified technical team to work on products such as:
Firewall / NGFW/ UTM: Sophos, Check Point, Palo Alto, Fortinet, WatchGuard and SonicWALL.
...
We give our best in fulfilling the customer’s requirements with best products and services and assist customers to choose the best products as per sizing and price benefits. Our pioneered adoption is the flexible business practices that benefit our clients, translating to value additions and enabling them to operate securely with more efficiently and effectively.
I would request you to give us some time for the brief discussion about our services and understand your infrastructure as per your convenient schedule. Waiting for your prompt response
<br /><br />
              </p>
            </div>

            {/* Blog Section 3 */}
            <div className="blog-content" id="best-security-practices">
              <img src="/Security-tips.jpg" alt="Image" id="Security" />
              <h2>Best Security Practices designed to beat systems before attackers do it</h2>
              <p>“Cybersecurity is a shared responsibility,and it boils down to this: In Cybersecurity,The more systems we secure, The more secure we all are” <br /><br />
...
<br /><br />
            ...
            {/* Blog Section 5 */}
            <div className="blog-content" id="Avoid-Attacks">
              <img src="/Cyber-security.jpg" alt="Image" id="attacker" />
              <h2>Only Attacks Can Help You Avoid Attacks</h2>
              <p>“Cybersecurity is a shared responsibility, and it boils down to this: In Cybersecurity,
